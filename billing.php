...
<!--                        </table>-->
                ...
                <?php
$slno = 0;
$basic_rate_total = '';$total_qty = '';$total_dp = '';$sTotal_bv = '';$total_bv = '';$total_amt = '';
...
<!--                        <table class="table">-->
<!--                            <tr>-->
<!--                                <td class="pxfont">--><?php //echo $qty; ?><!--</td>-->
<!--                                <td class="pxfont">--><?php //echo $qty; ?><!--</td>-->
<!--                            </tr>-->
<!--                        </table>-->
                    </td>
    ...
    <?php
                ...
                <tr>
                   ...
                   <td></td>
                    <td></td>
                    <td><?php echo $total_qty; ?>
<!--                        <table class="table">-->
<!--                            <tr>-->
<!--                                <td class="pxfont">--><?php //echo $total_qty; ?><!--</td>-->
<!--                                <td class="pxfont">--><?php //echo $total_qty; ?><!--</td>-->
<!--                            </tr>-->
<!--                        </table>-->
                    </td>
