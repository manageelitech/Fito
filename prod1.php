...
<script>
    ...
    */
    ...
    $(document).ready(function(){
        ...
        var subcatid = getUrlParameter('subcat');
        // alert(catid);
        $.ajax({
            url:"prodfetch1.php",
            method:"POST",
            data:{page:1,catid:catid,subcatid:subcatid,query:''},
            success:function(data)
            {
        ...
        $(document).on('click', '.page-link', function(){
            ...
            $.ajax({
                url:"prodfetch1.php",
                method:"POST",
                data:{page:page,catid:catid,subcatid:subcatid,query:query},
                success:function(data)
                {
                    $('#dynamic_content').html(data);
                }
        ...
        $('#search_box').keyup(function(){
            ...
            $.ajax({
                url:"prodfetch1.php",
                method:"POST",
                data:{page:1,catid:catid,subcatid:subcatid,query:query},
                success:function(data)
                {
                    $('#dynamic_content').html(data);
                }
