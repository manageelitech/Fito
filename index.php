...
*/
    ...
    <div class="col-sm-4 col-sm-offset-2">
        <form method="posr">
            <div class="input-group input-group-sm">
                <input type="text" class="form-control" name="search_box" id="search_box" placeholder="search Product" autocomplete="off">
    ...
    <div class="col-sm-4">
        <form method="posr">
            <div class="input-group input-group-sm">
                <input type="text" class="form-control" name="search_box1" placeholder="search Tie Up Shop"  id="search_box1" autocomplete="off">
                <span class="input-group-btn">
                    <button type="button" name="search" class="btn btn-success btn-flat">Search</button>
                </span>
            </div>
...
<section class="section-padding hide" id="search-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="seller-heading-txt wow" id="search-content-query">
                    You Searched for
                </div>
            </div>
...
<!--                    <p style="font-weight: bold;letter-spacing: 0.5px;font-size: 16px;color: #27c12d;"><i class="fa fa-shopping-cart"></i> Fito Hm Shop</p>-->
<!--                    <address style="color: #626159;"><i class="fa fa-map-marker"></i>-->
<!--                        Office: # H.No. 3-146/1,LIC Colony,PALAMANER-->
<!--                        Chittoor,ANDHRA PRADESH.-->
<!--                        PIN CODE:-517408-->
<!--                    </address>-->
<!--                    <p style="color: #73716a;"><i class="fa fa-mobile"></i> 9441117070</p>-->
<!--                </div>-->
<!--            </div>-->
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row" id="dynamic_content">
            <div class="swiper-container mySwiper" style="margin: 0 30px;">
                <div class="swiper-wrapper">
                    <?php
                    $qry = $conn->query("Select * from products where sub_category='16' limit 20");
                    while ($row = $qry->fetch_assoc()) {
                        $id = $row['slno'];
                        $prodname = $row['product_name'];
                        $imgname = $row['product_image'];
...
$(document).ready(function() {
    ...
    function load_products1(page, query = '') {
        $.ajax({
            url: "fetch_tie_up.php",
            method: "POST",
            data: {
                page: page,
                query: query
    ...
    $('#search_box').keyup(function() {
        ...
        if (query != ''){
            ...
            if (query.length > 0){
                $('#search-content-query').html('You Searched for "'+query+'"');
            }
            else{
                $('#search-content-query').html('');
            }
        }else {
            $('#search-content-query').html('');
