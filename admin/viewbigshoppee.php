...
$table.=  '<div class="box-body table-responsive no-padding"><table  class="table table-hover" id="producttable">
                        ...
                        <tbody>';
$slno = 0;
$qry=mysqli_query($conn,"SELECT * FROM bigshoppee_info");
while($res=mysqli_fetch_array($qry)) {
    ...
    $table .= '
            <tr>
                            ...
                            <td class="">' . $ifsc . '</td>
                            <td class="">' . $date . '</td>
                            <td onclick="deleteBigshoppee(this);"><a href="javascript:void(0)"><i class="fa fa-trash" style="color: red;font-size: 20px;"></i></a></td>
                            <td onclick="updateBigshoppee(this);"><a href="javascript:void(0)"><i class="fa fa-edit" style="color: blue;font-size: 20px;"></i></a></td>
                        </tr>';
}
