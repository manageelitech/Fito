...
$table.=  '<div class="box-body table-responsive no-padding"><table  class="table table-hover" id="bigstocktable">
                        <thead>
                        <tr>
                            <th class="hide">Id</th>
                            <th>SL No</th>
                        ...
                        <tbody>';
$slno = 0;
$qry=mysqli_query($conn,"SELECT * FROM big_shoppee_products where pcode='$uid'");
...
echo json_encode(array("res"=> 1, "bigstocklist" => $table));
?>