...
$table.=  '<div class="box-body table-responsive no-padding"><table  class="table table-hover" id="producttable">
                        ...
                        <tbody>';
$slno = 0;
$qry=mysqli_query($conn,"SELECT * FROM cart where status='cart' and userid='$uid'");
while($res=mysqli_fetch_array($qry))
{
    ...
    $table.='
            <tr>
                            ...
                            <td class="">'.$totalbv.'</td>
                            <td onclick="deleteCart(this);"><a href="javascript:void(0)"><i class="fa fa-remove" style="color: red;font-size: 20px;text-align: center;"></i></a></td>
                        </tr>';
}
