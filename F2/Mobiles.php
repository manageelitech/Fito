    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12"
                ...
                <form action="" id='add_post_form_mobiles' method='post' class='form-horizontal'>
                    <fieldset id="account">
                        <div class="form-group required">
                            <label class="control-label">Type Of Sell</label> <br />
                            <select class="form-control" id='add_post_form_mobiles_type_of_sale'>
                        ...
                        <div class="form-group required">
                            ...
                            <select class="form-control" id='add_post_form_mobiles_brand'>
                                <option value="">Select brand</option>
                                <option value="Iphone" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Iphone</option>
                                <option value="Vivo" style="background-color: rgb(245 180 211); font-weight: bold;">Vivo
                                </option>
                                <option value="Oppo" style="background-color: rgb(245 180 211); font-weight: bold;">Oppo
                                </option>
                                <option value="Intex" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Intex</option>
                                <option value="Micromax" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Micromax</option>
                                <option value="Realme" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Realme</option>
                                <option value="MI" style="background-color: rgb(245 180 211); font-weight: bold;">MI
                                </option>
                                <option value="Asus" style="background-color: rgb(245 180 211); font-weight: bold;">Asus
                                </option>
                                <option value="Blackberry"
                                    style="background-color: rgb(245 180 211); font-weight: bold;">Blackberry</option>
                                <option value="Lenovo" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Lenovo</option>
                                <option value="LG" style="background-color: rgb(245 180 211); font-weight: bold;">LG
                                </option>
                                <option value="Samsung" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Samsung</option>
                                <option value="Nokia" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Nokia</option>
                                <option value="One Plus" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    One Plus</option>
                                <option value="HTC" style="background-color: rgb(245 180 211); font-weight: bold;">HTC
                                </option>
                                <option value="Motorola" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Motorola</option>
                                <option value="Sony" style="background-color: rgb(245 180 211); font-weight: bold;">Sony
                                </option>
                                <option value="Karbonn" style="background-color: rgb(245 180 211); font-weight: bold;">
                                    Karbonn</option>
                        ...
                        <div class="form-group required">
                            ...
                            <input type="text" class="form-control" placeholder="Model Name"
                                id='add_post_form_mobiles_model'>
                        </div>


                        <div class="form-group required">
                            <label class="control-label">Year</label> <br />
                            <input type="text" class="form-control" id='add_post_form_mobiles_year'>
                        </div>

                        <div class="form-group required">
                            <label class="control-label">No. of Owners</label> <br />
                            <label class="radio-inline">
                                <input type="radio" name="add_post_form_mobiles_owner" value="1st" checked> 1st
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="add_post_form_mobiles_owner" value="2nd"> 2nd
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="add_post_form_mobiles_owner" value="3rd"> 3rd
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="add_post_form_mobiles_owner" value="4th"> 4th
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="add_post_form_mobiles_owner" value="4+"> 4+
                            </label>
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Ad title</label> <br />
                            <input type="text" class="form-control" id="add_post_form_mobiles_title">
                        </div>
                        <div class="form-group required">
                            <label class="control-label">Description </label> <br />
                            <textarea class="form-control" id="add_post_form_mobiles_desc"></textarea>
                        </div>
                        <div class="form-group required">
                            <label class="control-label">Sale Price</label> <br />
                            <input type="text" class="form-control" id="add_post_form_mobiles_price">
                        </div>
                        <div class="form-group required">
                            <label class="control-label">State</label> <br />
                            <select class="form-control" id='add_post_form_mobiles_state'>
                        ...
                        <div class="form-group required">
                            ...
                            <input type="text" class="form-control" placeholder="City Name"
                                id="add_post_form_mobiles_city">
                        </div>

                        <div class="form-group required">
                            <label class="control-label">Near By Town Name</label> <br />
                            <input type="text" class="form-control" id='add_post_form_mobiles_town'>
                        </div>

            </div>
            <div class="form-group required">
                <label class="control-label">images</label> <br />
                <input type="file" class="form-control" id="add_post_form_mobiles_files"
                    name="add_post_form_mobiles_files[]" multiple>
            </div>
            ...
            <div class="form-group required">
                ...
                <label class="radio-inline">
                    <input type="radio" name="add_post_form_mobiles_referrer" value="Mediator" checked> Mediator
                </label>



                <label class="radio-inline">
                    <input type="radio" name="add_post_form_mobiles_referrer" value="Owner"> Owner
                </label>
            </div>
            <div class="form-group required">
                <label class="control-label">Your Name</label> <br />
                <input type="text" class="form-control" placeholder="Your Name" id="add_post_form_mobiles_name">
            </div>
            <div class="form-group required">
                <label class="control-label">Your Number</label> <br />
                <input type="phone" class="form-control" placeholder="Phone" id="add_post_form_mobiles_phone">
            </div>
            <div class="form-group required">
                <label class="control-label">Your Town And Address</label> <br />
                <input type="text" class="form-control" placeholder="Your Town & Address"
                    id="add_post_form_mobiles_town">
            </div>

            <div class="form-group required">
                <label class="control-label">Document Xerox Submit</label> <br />
                <label class="radio-inline">
                    <input type="radio" name="add_post_form_mobiles_Document_Xerox" value="Mediator" checked> Yes
                </label>



                <label class="radio-inline">
                    <input type="radio" name="add_post_form_mobiles_Document_Xerox" value="Owner"> No
                </label>
            </div>
            <div class="form-group required">
                <label class="control-label">Document Holder Name</label> <br />
                <input type="text" class="form-control" id="add_post_form_mobiles_Document_Holder_Name">
            </div>
            ...
            <div class="buttons">
                <div class="form-group">
                    <input type="button" value="Submit" id="add_post_form_mobiles_btnAdd" class="btn btn-primary" />
                </div>
                </form>
            </div>
        </div>
...
//     getVarient(model);
// });
$('#add_post_form_mobiles_btnAdd').on("click", function(e) {
    e.preventDefault();

    var uid = localStorage.getItem('uid');
    var catid = '<?php echo $cat_id ?>';
    var subcatid = '<?php echo $sub_cat_id ?>';
    let type_of_sale = $('#add_post_form_mobiles_type_of_sale').val();
    let brand = $('#add_post_form_mobiles_brand').val();
    let model = $('#add_post_form_mobiles_model').val();

    let year = $('#add_post_form_mobiles_year').val();

    let owner = $('input[name="add_post_form_mobiles_owner"]:checked').val();
    let referrer = $('input[name="add_post_form_mobiles_referrer"]:checked').val();
    let title = $('#add_post_form_mobiles_title').val();
    let desc = $('#add_post_form_mobiles_desc').val();
    let price = $('#add_post_form_mobiles_price').val();
    let state = $('#add_post_form_mobiles_state').val();
    let city = $('#add_post_form_mobiles_city').val();
    let name = $('#add_post_form_mobiles_name').val();
    let phone = $('#add_post_form_mobiles_phone').val();
    let town = $('#add_post_form_mobiles_town').val();
    let Document_Xerox = $('input[name="add_post_form_mobiles_Document_Xerox"]:checked').val();
    let Document_Holder_Name = $('#add_post_form_mobiles_Document_Holder_Name').val();

    // console.log(Document_Xerox,Document_Holder_Name);return;

    var form_data = new FormData();

    form_data.append("fid", 10);
    ...
    // Read selected files
    var totalfiles = document.getElementById('add_post_form_mobiles_files').files.length;
    for (var index = 0; index < totalfiles; index++) {
        form_data.append("files[]", document.getElementById('add_post_form_mobiles_files').files[index]);
    }
    $.ajax({
        url: 'functions.php',
        type: 'post',
...
function getModel(brand) {
    $.ajax({
        ...
        .done(function(response) {
            $('#add_post_form_mobiles_model').html(response.model);
        });
}
...
//     })
//         .done(function(response){
//             $('#add_post_form__varient').html(response.varient);
//         });
// }
</script>
<?php
