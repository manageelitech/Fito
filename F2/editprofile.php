    ...
    <div class="commontop row">                <div id="content" class="col-sm-12 login">
      ...
      <form action="https://ocsolutions.co.in/classifieddemo-script/index.php?route=classified/register" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
		  ...
		  <label class="control-label">Edit Your Name</label> <br/>
            <i class="la la-user"></i>
            <input type="text" name="firstname" value="" placeholder="Edit Name" id="input-firstname" class="form-control" />
                        </div> -->
          <!-- <div class="form-group required">
		   <label class="control-label">Last Name</label> <br/>
              ...
              <input type="text" name="lastname" value="" placeholder="Last Name" id="input-lastname" class="form-control" />
                        ...
                        <div class="form-group required">
		  <label class="control-label">Change Phone Number</label> <br/>
            <i class="la la-user"></i>
            <input type="text" name="firstname" value="" placeholder="Edit Phone Number" id="input-firstname" class="form-control" />
                        </div>

          <div class="form-group required">
		     <label class="control-label">Change E-Mail</label> <br/>
              <i class="la la-envelope-o"></i>
              <input type="email" name="email" value="" placeholder="Change E-Mail" id="input-email" class="form-control" />
                        </div>
        </fieldset>
        <fieldset>
          <div class="form-group required">
		   <label class="control-label">Change Password</label> <br/>
            <i class="la la-unlock"></i>
              <input type="password" name="password" value="" placeholder="Change Password" id="input-password" class="form-control" />
                        </div>
          <div class="form-group required">
