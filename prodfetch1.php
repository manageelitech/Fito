...
$limit = '20';
$page = 1;
$catid = $connobj->decryptIt($_POST['catid']);
$subcatid = $connobj->decryptIt($_POST['subcatid']);
if ($_POST['page'] > 1) {
...
$query = "SELECT * FROM products where category='$catid' and sub_category='$subcatid'";
...
if ($total_data > 0) {
 ...
 price">ADCP</abbr>:'.$dp.' Rs  | Bv:'.$bv.' p</div></a>
    ...
    $output .= '
  <p style="text-align: center;font-size: 30px;">PRODUCT COMMING SOON.....</p>
  ';
}
